...
{
public:
    virtual bool isRightAttackInPassing(const GameBoard &board, const std::vector<Note> &log, const stf::Vec2d& selected, const stf::Vec2d& selectable);;
    virtual bool isLeftAttackInPassing(const GameBoard &board, const std::vector<Note> &log, const stf::Vec2d& selected, const stf::Vec2d& selectable);;
...
{
public:
    bool isRightAttackInPassing(const GameBoard &board, const std::vector<Note> &log, const stf::Vec2d& selected, const stf::Vec2d& selectable) final;
